...
- [ ] 3, 17.05.2017: «Create New Note» auf der Detail-Seite implementieren.Die Daten in den «LocalStorage» einpflegen. Navigation zwischen den beiden HTML-Seiten.
      Auf der Hauptseite die Anzahl darstellen. Style Switcher implementieren.
...
- [ ] 4, 24.05.2017: Hauptseite ausprogrammieren: Anzeigen der Einträge / Filtern / Sortieren
      Handlebars verwenden für das Rendern der Einträge.
...
- [ ] 5, 31.05.2017: JavaScript optimieren. Patterns anwenden. Nutzen von Klassen für die Datenhaltung.
 (Revealing) Module Pattern für die"Datenklassen" erstellen. IIFE anwenden.
